...
<nav
  class="name:nav flex w-screen items-center justify-around px-4 text-xl sm:mx-2 sm:h-screen sm:w-1/5 sm:flex-col sm:items-start lg:absolute lg:left-0 lg:z-10 lg:px-4"
>
